...
int main(int argc,char *argv[])
{
    ...
    join_adr.imr_multiaddr.s_addr=inet_addr(argv[1]);//多播组地址信息
    join_adr.imr_interface.s_addr=htonl(INADDR_ANY);//加入多播组的主机地址信息
    setsockopt(recv_sock,IPPROTO_IP,IP_ADD_MEMBERSHIP,(void*)&join_adr,sizeof(join_adr));//加入组播
